            ...
            <div id="plane">
                <form action="addCourse.php" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" name="itemname" type="text" placeholder="Course Name" autofocus="true" /></td>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" name="itemscratch" type="number" placeholder="Standard Scratch" /></td>
                        </div>
                    </div>

            ...
            <div id="plane">
                ...
                <table style="float: left">
                    ...
                    <tr>
                        ...
                        <td><input class="input-sm" id="net10" name="net1" type="text" disabled="disabled"></td>
                ...
                <div style="float: left">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" id="endscore" name="endscore" type="number" min="0" max="64" step="1" disabled="disabled"/>
                        </div>
                    </div>
               </div>
            </div>
